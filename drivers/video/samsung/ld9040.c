...
// MERGE
// 	if (lcd->acl_enable) {
// 		if (lcd->current_acl == 0) {
// 			if (lcd->bl == 0 || lcd->bl == 1) {
// 				ret = ld9040_panel_send_sequence(lcd, pdata->acl_table[0]);
// 				dev_dbg(&lcd->ld->dev, "%s : current_acl=%d, acl_off\n", __func__, lcd->current_acl);
// 			} else {
// 				ret = ld9040_panel_send_sequence(lcd, pdata->acl_on);
// 				dev_dbg(&lcd->ld->dev, "%s : current_acl=%d, acl_on\n", __func__, lcd->current_acl);
// 			}
// 		}
// 		switch (lcd->bl) {
// 		case 0 ... 1: /* 30cd ~ 40cd */
...
// 				ret = ld9040_panel_send_sequence(lcd, pdata->acl_table[0]);
// 				lcd->current_acl = 0;
// 				dev_dbg(&lcd->ld->dev, "%s : current_acl=%d\n", __func__, lcd->current_acl);
// 			}
// 			break;
// 		case 2 ... 19: /* 70cd ~ 250cd */
// 			if (lcd->current_acl != 40) {
